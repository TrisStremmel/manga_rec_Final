...
app.post('/api/user/mal-cold-start/', function(req,res){
    ...
    const python = spawn('H:/manga_rec/magna_rec_packages/mangaRecommender/venv/Scripts/python', ['mangaRecommender/addUser.py', req.body.username, req.body.userId]);
...
app.post('/api/manga/recommend', function(req,res){
    ...
    const python = spawn('H:/manga_rec/magna_rec_packages/mangaRecommender/venv/Scripts/python', ['mangaRecommender/recommender.py', req.body.userId, req.body.filters]);
